      ...
      <div class="card-body">
        ...
        <form id="formValidationExamples" action={{ route('updateFilters') }} class="row g-3">
          ...
          <div class="col-md-6">
            ...
            <select class="selectpicker w-100" id="formValidationCountries"  data-style="btn-default" data-icon-base="bx" data-tick-icon="bx-check text-white" name="formValidationCountries[]" multiple>
              @foreach ($countries as $country)
              <option value="{{ $country->id }}" @if(in_array($country->id, $filter->countries()->pluck('countries.id')->all() )) selected @endif >
          ...
          <div class="col-md-6">
            ...
            <div class="form-check">
              <input type="checkbox" class="form-check-input" id="formValidationCheckbox" name="formValidationCrawler" value="1" @if ($filter->crawler_on)
              checked
              @endif />
