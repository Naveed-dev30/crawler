...
@section('content')
    <div class="d-flex flex-wrap justify-content-between align-items-end mb-3 gap-2">
        <div>
            ...
            @if ($refreshedAt)
                <small class="text-muted">Refreshed: {{ $refreshedAt->format('Y-m-d H:i') }} · {{ $snapshotCount }}
                    snapshots</small>
            @endif
        </div>
            ...
            <div class="col-md-4">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <h3 class="fw-bold mb-0">{{ $latest->self_score !== null ? number_format($latest->self_score) : '—' }}
                        </h3>
                    </div>
                </div>
            </div>
